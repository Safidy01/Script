...
**Execution du code**  
rehefa avy nanova ny numéro tao amin'ny start.sh :  
> bash start.sh

Raha tinao atao mitokatona ny bot dia ampiasao ity :  
> python bot.py +[phone] [coin] 

**Note :**  
 `[phone]` = Ilay numero ao amin'ny Telegram no atao eto  
 `[coin]` = Titre Coin atao oh: btc/ltc/bch/doge izay tianao  
